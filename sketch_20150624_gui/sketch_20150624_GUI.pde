...
void setup() {
  size(1920,1080, P3D);                                        // create size
  ...
  serial2 = GEOport.readStringUntil(end);                  //function that reads the string from serial port until a println and then assigns string to our string variable (called 'serial')
...
void draw() {
  ...
  fill(255);
  arc(1818, 550, 80, 80, radians(-225), radians(lightMap1),  PIE);
  fill(0);
  ...
  fill(255);
  arc(1818, 685, 80, 80, radians(-225), radians(lightMap2),  PIE);
  fill(0);
  ...
  fill(255);
  arc(1818, 820, 80, 80, radians(-225), radians(lightMap3),  PIE);
  fill(0);
...
////////////////////////// CAMERA DISPLAY /////////////////////////////////////////
  ...
  if (cameraStatus == 1) {                                                         // First asks camera status from setup. If there is not screen will display
    if (videoFeed == true) {                                                       // "No Camera Available"
