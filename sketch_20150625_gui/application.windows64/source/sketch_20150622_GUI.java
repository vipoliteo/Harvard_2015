...
public class sketch_20150622_GUI extends PApplet {
...
public void draw() {
  ...
  float[] a = PApplet.parseFloat(splitTokens(serial, ","));
 ...
 tempBanner[0]=bannerValue;
  ...
  float fadeOld = map (i, 0, fadeOne, 255, 0);
  stroke(255, 255, 255, fadeOld);
  strokeWeight(5);
...
public void toggle(boolean theFlag) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_20150622_GUI" };
    if (passedArgs != null) {
